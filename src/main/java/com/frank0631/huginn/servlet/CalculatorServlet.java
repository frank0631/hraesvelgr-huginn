...
public class CalculatorServlet {
    ...
    public ServletRegistrationBean calculator(TProtocolFactory protocolFactory, CalculatorServiceHandler handler) {
        ...
        Servlet calculatorServlet = new TServlet(new com.frank0631.nidhogg.calculator.TCalculatorService.Processor<CalculatorServiceHandler>(handler), protocolFactory);
